...
Create a .env file in the backend directory (see Configuration section for details)
...
npm install
Create a .env file in the frontend directory (see Configuration section for details)
